...
const Home = () => {
	...
	useEffect(() => {
		const getCategories = async () => {
			try {
				...
				// console.log(typeof category.image, category.image);
			} catch (error) {
				console.log(error);
			}
		};
	...
	const extractText = (htmlString) => {
		...
		// Setting the first letter of category name for alphabet image fallback.
		setFirstLetter(textContent.charAt(0).toUpperCase());
